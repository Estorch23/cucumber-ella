...
//import static Utils.PageIntializer.addEmployeePage;
...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_enter_firstname_and_lastname() {
        ...
        sendText("Ella",firstname);
        //lastname.sendKeys("chikhi");
        sendText("Storch",lastname);
    }
    ...
    public void user_enter_and_and_in_the_application(String firstname, String middleName, String lastname) {
       ...
       // firstnameLocator.sendKeys(firstname);
        sendText("Ella",firstnameLocator);
       //middleNameLocator.sendKeys(middleName);
        sendText("Diana",middleNameLocator);

        //lastnameLocator.sendKeys(lastname);
        sendText("Storch",lastnameLocator);
    }
    ...
    public void user_adds_multiple_employee_from_excel_using_and_verify_it(String Sheet1) throws IOException {
